...
$scope.employee_degree = {};
  ...
  $scope.newEmployee_Degree = function(){
    ...
    site.showModal('#addEmployee_DegreeModal');
  };
  $scope.add = function() {
    $scope.error = '';
    ...
    $scope.busy = true;
     $http({
       ...
       function(response) {
        $scope.busy = false;
         if (response.data.done) {
          site.hideModal('#addEmployee_DegreeModal');
          $scope.loadAll();
         }else{
   ...
   $scope.edit = function(employee_degree){
    ...
    $scope.employee_degree = {};
     site.showModal('#updateEmployee_DegreeModal');
   };
    ...
    $scope.busy = true;
     $http({
       ...
       function(response) {
        $scope.busy = false;
         if (response.data.done) {
          site.hideModal('#updateEmployee_DegreeModal');
          $scope.loadAll();
         }else{
          $scope.error = '##word.error##';
         }
   ...
   $scope.remove = function(employee_degree){
    $scope.view(employee_degree);
    $scope.employee_degree = {};
    site.showModal('#deleteEmployee_DegreeModal');
  };
  ...
  $scope.details = function(employee_degree){
    $scope.view(employee_degree);
    $scope.employee_degree = {};
   site.showModal('#viewEmployee_DegreeModal');
  };
    ...
    $scope.busy = true;
     $http({
       ...
       function(response) {
        $scope.busy = false;
         if (response.data.done) {
          site.hideModal('#deleteEmployee_DegreeModal');
          $scope.loadAll();
         }else{
          $scope.error = response.data.error;
         }
